...
\section{Skills}
 \resumeSubHeadingListStart
    ...
    \item{
     \textbf{Technologies}{: Java8, Scala, RxJava, Play, Docker, Kubernetes, Prometheus, Vault, Keycloak }
    }
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Head of Engineering}{April 2012 - Present}
      \resumeItemListStart
...
\section{Side Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \item{A food delivery app created long before mobile apps became prevalent. It was a web-based service, which catered to foodies in Hyderabad, India. I desinged and developed the customer-facing web app and an administration console, for managing daily operations. }
        \resumeItem{Skills Learnt}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Universal Digial Library (UDL)} 
          {Research and Development of tools and technologies required for digital libraries in collobaration with CMU, USA and IISc, India}
        \resumeItem{Technology Developement in Indian Languages (TDIL) }
          {Development of Software modules for various NLP tools tailored for the Indian Languages}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
